...
void Graph::loadGraphFromFileWithReindexing(const std::string& file_path){
    ...
    while(input_file >> begin){ // Read edge.
        ...
        if(neighborhood_label_count[vtx_map_after_partition[begin]].find(labels[vtx_map_after_partition[end]]) 
                    == neighborhood_label_count[vtx_map_after_partition[end]].end()){
            neighborhood_label_count[vtx_map_after_partition[begin]][labels[vtx_map_after_partition[end]]] = 0;
        }
        neighborhood_label_count[vtx_map_after_partition[begin]][labels[vtx_map_after_partition[end]]] += 1;

        if(neighborhood_label_count[vtx_map_after_partition[end]].find(labels[vtx_map_after_partition[begin]]) 
                    == neighborhood_label_count[vtx_map_after_partition[begin]].end()){
            neighborhood_label_count[vtx_map_after_partition[end]][labels[vtx_map_after_partition[begin]]] = 0;
        }
        neighborhood_label_count[vtx_map_after_partition[end]][labels[vtx_map_after_partition[begin]]] += 1;
